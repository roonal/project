				...
				<div class="col-lg-3 m-lg-auto">
					<div class="card text-black bg-light mb-5 mt-5" style="width:40rem;">
						<div class="card-body">
							...
							<div class="pt-3">
								<button type="submit" class="btn btn-success btn-md btn-block register-button text-uppercase" name="login" value="login">Login</button>
							</div>
							<?php echo form_close(); ?>
							<label class="text-lg-center pt-3">
							<a href="<?= base_url('Auth/resetPsw'); ?>"><u>Forgot Password?</u></a>
							</label>
							<br>
							<label class="text-lg-center " >
								Do not have an account? <a href="<?= base_url('home/register_page'); ?>"><u>Register Now</u></a>
							</label>
						</div>
					</div>
				</div>
