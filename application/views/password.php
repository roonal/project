					...
					<div class="card text-black bg-light mb-5 mt-5" style="width:40rem;">
						<div class="card-body">
							...
							<div class="form-group ">
								...
								<input type="Opassword" placeholder="Old Password" class="form-control" id="exampleInputPasswordOld"name="old_password"autocomplete="off" >
								<span class="text-danger"><?php echo form_error('user_password');?>
								</span>
							</div>
							<div class="form-group ">
								<label for="exampleInputPassword">new Password</label>
								<input type="password" placeholder="Password" class="form-control" id="exampleInputPassword"name="new_password"autocomplete="off" >
								<span class="text-danger"><?php echo form_error('user_password');?>
								</span>
							</div>
							<div class="form-group ">
